...
from modules.blocks import UnifiedTransformerBlock
...
class TransformerStack(nn.Module):
    ...
    def forward(
        ...
        protein_struct_emb: torch.Tensor | None = None,
        ...
        *batch_dims, _ = x.shape
        ...
        for block in self.blocks:
            x = block(x, sequence_id, affine, affine_mask, chain_id, encoder_hidden=protein_struct_emb, encoder_mask=protein_mask, attributes=attributes, attr_cross_attention_mask=attr_cross_attention_mask)
            hiddens.append(x)
