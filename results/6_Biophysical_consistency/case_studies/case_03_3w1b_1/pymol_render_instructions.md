...
1. `pymol /root/autodl-tmp/Peptide_3D/results/5_robustness/baseline/cache/hdock_work/rfdiffusion/pocket_noise_lvl1p0_r0/3w1b/model_1.pdb`
2. `@pymol_interface_selections.pml`（或粘贴其中 `select` 命令）
3. `set ray_trace_mode, 1` → `png figure_ray.png, width=2400`

## 结构文件

- 复合物 PDB：`/root/autodl-tmp/Peptide_3D/results/5_robustness/baseline/cache/hdock_work/rfdiffusion/pocket_noise_lvl1p0_r0/3w1b/model_1.pdb`
