...
1. `pymol /root/autodl-tmp/Peptide_3D/results/5_robustness/cache/hdock_work/pocket_noise_lvl0p0_r0/2p1o/pep_01/model_1.pdb`
2. `@pymol_interface_selections.pml`（或粘贴其中 `select` 命令）
3. `set ray_trace_mode, 1` → `png figure_ray.png, width=2400`

## 结构文件

- 复合物 PDB：`/root/autodl-tmp/Peptide_3D/results/5_robustness/cache/hdock_work/pocket_noise_lvl0p0_r0/2p1o/pep_01/model_1.pdb`

链 ID（来自 Table_S8）：肽 **P**，靶 **B**。
